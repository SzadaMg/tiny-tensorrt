...
GetInt8Calibrator(const std::string &calibratorType, int batchSize,
  ...
  return new TrtInt8Calibrator(calibratorType, batchSize, dataPath,
                               calibrateCachePath);
}
...
int TrtInt8Calibrator::getBatchSize() const TRT_NOEXCEPT {
  spdlog::info("get batch size {}", mBatchSize);
  return mBatchSize;
}

bool TrtInt8Calibrator::getBatch(void *bindings[], const char *names[],
                                 int nbBindings) TRT_NOEXCEPT {
...
const void *
TrtInt8Calibrator::readCalibrationCache(size_t &length) TRT_NOEXCEPT {
...
void TrtInt8Calibrator::writeCalibrationCache(const void *cache,
...
nvinfer1::CalibrationAlgoType TrtInt8Calibrator::getAlgorithm() TRT_NOEXCEPT {
...
TrtInt8Calibrator::getInterfaceInfo() const TRT_NOEXCEPT {
  return nvinfer1::InterfaceInfo{"INT8_CALIBRATOR", 1, 0};
}
#endif
